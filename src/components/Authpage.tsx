...
const Authpage = ({content, transfer, destination, onButtonClick}: LogType) => {
   return (
      <div className='flex justify-center items-center w-screen h-screen overflow-hidden'>
         <div className="flex bg-zinc-300 w-[90%] md:w-[45%] xl:w-[35%] rounded-xl ">
            <div className="m-8 w-full flex gap-3 flex-col items-center justify-evenly ">
               ...
               <Button onClick={onButtonClick} className={`h-12 w-[95%] md:w-[80%] mt-2 ${roboto_slab.className} rounded bg-sky-600 py-2 px-4 text-lg text-white data-[hover]:bg-sky-500 data-[active]:bg-sky-700`}>
                  {content} With GOOGLE
               </Button>
